...
int main2(void) {
    ...
    char fname[13];
    char * files[] = {
        "/home/bruno/arquivo1.txt",
        "/home/bruno/arquivo2.txt",
        "/home/bruno/arquivo3.txt",
        "/home/bruno/arquivo4.txt",
    };
...
void run(){
    ...
    do{
        ...
        printf("1) Arquivo 1 com 0004 páginas de memória\n2) Arquivo 2 com 0004 páginas de memória\n3) Arquivo 3 com 0128 páginas de memória\n4) Arquivo 3 com 0256 páginas de memória\n5) Arquivo 3 com 1024 páginas de memória\n6) Arquivo 3 com 2048 páginas de memória\n7) Arquivo 4 com 0128 páginas de memória\n8) Arquivo 4 com 0256 páginas de memória\n9) Arquivo 4 com 1024 páginas de memória\n10)Arquivo 4 com 2048 páginas de memória\n");
        scanf("%d", &op);
        leitura = init_list();
        switch(op){
            case 1:
                MASK = 16;
                simula_nfu(leitura, files[0], 3, 1, 16);
                break;
            case 2:
                MASK = 16;
                simula_nfu(leitura, files[1], 3, 1, 16);
                break;
            case 3:
                MASK = 512;
                simula_nfu(leitura, files[2], 127, 20);
                break;
            case 4:
                MASK = 512;
                simula_nfu(leitura, files[2], 255, 50);
                break;
            case 5:
                MASK = 512;
                simula_nfu(leitura, files[2], 1023, 150);
                break;
            case 6:
                MASK = 512;
                simula_nfu(leitura, files[2], 2047, 500);
                break;
            case 7:
                MASK = 512;
                simula_nfu(leitura, files[3], 127, 20);
                break;
            case 8:
                MASK = 512;
                simula_nfu(leitura, files[3], 255, 50);
                break;
            case 9:
                MASK = 512;
                simula_nfu(leitura, files[3], 1023, 150);
                break;
            case 10:
                MASK = 512;
                simula_nfu(leitura, files[3], 2047, 500);
                break;
        }
